...
This action allows to create a new `Checkout Session` and redirect the user to Stripe to finalize the payment.
...
<ResponseField name="Return URL" type="text" required>
  URL that appears after cancelation of checkout.
...
<ResponseField name="Customer ID" type="text">
  The ID of Stripe's Customer object. This is used to to manage customer data for future payments.
...
This guide assumes you have a basic knowledge of Bubble's features.

<Steps>
  <Step title="Database setup">
    - Add 
      <Tooltip tip="The ID of Stripe's Customer object. This is used to to      manage customer data for future payments.">Customer ID</Tooltip>
      field to User table.
    - Create 
      <Tooltip tip="Table that represents each entry in your Order. It contains price and quantity of product.">Checkout Item</Tooltip>
      table. You can add any field you want but you have to also include
      <Tooltip tip="The ID of Stripe's price object. You can find it in Stripe's dashboard under Product details.">Price ID</Tooltip>
      and
      <Tooltip tip="The number that specifies quantity of each product.">Quantity</Tooltip>.
    - Create
      <Tooltip tip="The number that specifies quantity of each product.  ">Order</Tooltip> table. It You can add any field you want but you have to also include List of
      <Tooltip tip="Object that represents each entry in your Order. It contains price and quantity of product.">Checkout Items</Tooltip>.
  </Step>
  <Step title="Create checkout button">
    Create a button that will trigger our plugin's Checkout action. Fill out required fields. You can read more about each field in [Properties section](/plugins/stripe#Properties).
  </Step>
...
In case of any troubles regarding the plugin, we offer full support. Simply send us an email using `Support` button.